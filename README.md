...
Essa mudança torna o projeto **cientificamente mais sólido e transparente**.
...
Cada obra torna-se uma janela para compreender:
- criatividade
- decisões
- contexto histórico
...
1. **Modularidade** — cada recurso independente e reutilizável
2. **Transparência** — fatos ≠ inferências ≠ hipóteses ≠ conteúdo gerado
3. **Escalabilidade** — crescer sem reescrever a base
4. **Explicabilidade** — sempre mostrar evidências e limitações
5. **Preservação Cultural** — respeitar contexto histórico de obras e autores
